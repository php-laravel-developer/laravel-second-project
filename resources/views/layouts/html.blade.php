...
<html lang="en">
  <head>
	...
	<link href="{{ URL::to('/') }}/public/css/animate.min.css" rel="stylesheet"> 
	<link href="{{ URL::to('/') }}/public/css/animate.css" rel="stylesheet" />
	<link href="{{ URL::to('/') }}/public/css/prettyPhoto.css" rel="stylesheet"> 
  ...
  <body>
	...
	@include("html.partial.about" , ["dates"=>$names]) 
	@section("portfolio")
	@show
	...
	<script src="{{ URL::to('/') }}/public/js/jquery.prettyPhoto.js"></script>
    <script src="{{ URL::to('/') }}/public/js/jquery.isotope.min.js"></script> 
	<script src="{{ URL::to('/') }}/public/js/wow.min.js"></script>
	<script src="{{ URL::to('/') }}/public/js/jquery.easing.min.js"></script>	
